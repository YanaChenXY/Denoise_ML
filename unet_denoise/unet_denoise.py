...
if __name__ == "__main__":
    ...
    parser.add_argument("--split", default=0.85, type=float, help="Proportion of the data to train on")
    parser.add_argument("--epochs", default=10, type=int, help="Number of epochs to train.")
    parser.add_argument("--weights", default='unet_denoise_v1_0.h5', type=str, help="h5 file to read/write weights to")
    ...
    parser.add_argument("--load", default=True, action='store_true', help="Load previous weights file before starting")
