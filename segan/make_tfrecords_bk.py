...
def read_and_slice(filename, wav_canvas_size, stride=0.5):
    ...
    wav_data, fm = librosa.load(filename, sr=16000)
    _, percussive = librosa.effects.hpss(wav_data)
    if fm != 16000:
        raise ValueError('Sampling rate is expected to be 16kHz!')
    signals = slice_signal(percussive, wav_canvas_size, stride)
    return signals
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_file', type=str, default='segan_1.tfrecords',
