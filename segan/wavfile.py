...
def write(filename, rate, data):
    ...
    * The bits-per-sample and PCM/float will be determined by the data-type.
    ...
    try:
        ...
        print('format_tag:', type(format_tag))
        print(' channels:', type(channels))
        print('fs:', type(fs))
        print( 'bytes_per_second:', type(bytes_per_second))
        print('block_align:', type(block_align))
        print('bit_depth:', type(bit_depth))
        fmt_chunk_data = struct.pack('<IIffII', format_tag, channels, fs,
